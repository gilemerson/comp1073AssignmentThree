/*
    ...
    * File Description: ThankYou Javascript Page - (thank-you.js)
*/
...
headingOne.textContent = "Thank You";
...
headingTwo.textContent = "Welcome Discount";
...
paragraphOne.textContent = "Customers will receive a special 2017 discount";
...
headingThree.textContent = "24/7 Customer Support";
...
paragraphTwo.textContent = "Gil Emerson Design Studio offers 24/7/365 live team chat support to all out clients for any specific needs";
...
headingFour.textContent = "Free Estimates";
...
paragraphThree.textContent = "Receive free estimates";
...
headingFive.textContent = "Starter Package";
...
paragraphFour.textContent = "You will be offered one starter pack containing discounts and special offers";

//headingSix variable creates a link to refrece 
var headingSix = document.getElementById("headingSix");
console.log(headingSix.textContent);
headingSix.textContent = "Enhanced Social Marketing Tips";
...
paragraphFive.textContent = "Gil Emerson Design Studio will provide you with common practice tips on improving social marketing engagement and effectiveness";
